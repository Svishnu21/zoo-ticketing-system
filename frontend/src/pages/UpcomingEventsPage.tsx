    ...
    <div className="page-enter space-y-16 bg-soft-bg pb-20">
      <section className="relative isolate overflow-hidden">
        <div className="absolute inset-0">
          <img
            src={aboutParkImage}
            alt="Festive foliage background"
          ...
          <div className="container py-16">
            <div className="mx-auto max-w-3xl space-y-4 text-center">
              ...
              <p className="text-base font-medium text-white/85 md:text-lg">
                Celebrate nature with us through season-long programs.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="mx-auto max-w-4xl space-y-8 rounded-3xl border border-forest-green/15 bg-white/95 p-8 shadow-xl backdrop-blur sm:p-10 md:p-12">
            <div className="space-y-4 text-forest-green">
              <h2 className="text-3xl font-bold md:text-4xl">Celebrations &amp; Awareness</h2>
              <p className="text-lg leading-relaxed text-forest-green/90">
                Environmental awareness is raised by observing and celebrating environment-related events at the Zoo. We
                celebrate days of environmental importance, such as Wildlife Week and World Forestry Day, as well as days of
                national importance like Independence Day and Republic Day.
              </p>
            </div>

            <div className="space-y-4 text-forest-green">
              <h2 className="text-3xl font-bold md:text-4xl">Event Schedule</h2>
              <p className="text-lg leading-relaxed text-forest-green/90">
                Please check this page regularly for updates on our next celebration or awareness event. We look forward to
                seeing you!
              </p>
            </div>
          </div>
