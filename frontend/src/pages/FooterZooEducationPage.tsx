...
export function FooterZooEducationPage() {
  return (
    <div className="page-enter space-y-16 bg-soft-bg pb-20">
      <section className="relative isolate overflow-hidden">
        <div className="absolute inset-0">
          <img
            src={aboutParkImage}
            alt="Educational boardwalk through the park"
          ...
          <div className="container py-16">
            <div className="mx-auto max-w-3xl space-y-4 text-center">
              ...
              <p className="text-base font-medium text-white/85 md:text-lg">
                Inspiring curious minds through every visit.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="mx-auto max-w-4xl space-y-10 rounded-3xl border border-forest-green/15 bg-white/95 p-8 shadow-xl backdrop-blur sm:p-10 md:p-12">
            <div className="space-y-4 text-forest-green">
              ...
              <p className="text-lg leading-relaxed text-forest-green/90">
                We are committed to providing nature education. We provide education through large signage panels at each
                animal exhibit describing each species&apos; appearance, behavior, and conservation status. The trees inside the
                zoo are also botanically labelled. [cite: 234, 235]
              </p>
            </div>
            ...
            <div className="space-y-4 text-forest-green">
              ...
              <p className="text-lg leading-relaxed text-forest-green/90">
                We welcome educational visits from schools and academic institutions year-round. During visits from vocational
                institutions, our Forest Officials and Biologists give talks on zoo management and share real-life
                conservation insights. [cite: 232, 237]
              </p>
            </div>

            <Button asChild variant="default" size="lg" className="mt-4 self-start">
              <Link to="/zoo-school">View School Programs</Link>
            </Button>
          </div>
        </div>
      </section>
